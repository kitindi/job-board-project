    ...
    <header>
      <div className="flex justify-between  ">
        <Link href="/" className="font-medium text-xl flex items-center gap-1">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#2563eb" fill="none">
              <path
        ...
        <nav className="flex gap-4 items-center *:px-4 *:py-2 *:rounded-md">
          ...
          {user && (
            <form action={action}>
              <button type="submit" className="px-4 py-2 rounded-md bg-gray-200">
                Sign out
              </button>
            </form>
          )}
